...
import { handleCreateManyThietbiV2 } from '@/app/(main)/quan-tri/thiet-biv2/actions';
...
const ModalImportv2 = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyThietbiV2(dataImport, access_token ?? '')
            ...
            >
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        Chỉ hỗ trợ file excel và csv <a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-device.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <div>
                    <Table<any>
