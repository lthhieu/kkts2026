'use client'
import { handleCreateOrUpdateNghiencuu } from '@/app/(main)/quan-tri/csvc/nghien-cuu/actions';
...
const NghiencuuModal = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        const response = await handleCreateOrUpdateNghiencuu(payload, access_token ?? '', status, dataUpdate);
        if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title={status === 'CREATE' ? 'Thêm phòng nghiên cứu' : 'Cập nhật phòng nghiên cứu'}
