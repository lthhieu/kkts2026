...
const DaphuongtienDetail = ({ data }: IProps) => {
    if (!data) return null
    ...
    return (
        <div>
            ...
            >
                ...
                <Descriptions.Item span={2} label="Số chỗ ngồi">{data.qui_mo_cho_ngoi ?? '—'}</Descriptions.Item>
...
export default DaphuongtienDetail
