...
import { handleCreateManyCountries } from '@/app/(main)/quan-tri/csvc/danh-muc/quoc-gia/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyCountries(dataImport, access_token ?? '');
