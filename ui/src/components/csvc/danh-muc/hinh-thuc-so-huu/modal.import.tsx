...
import { handleCreateManyHinhthucsohuu } from '@/app/(main)/quan-tri/csvc/danh-muc/hinh-thuc-so-huu/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyHinhthucsohuu(dataImport, access_token ?? '');
