...
import { handleCreateManyHinhthucsudung } from '@/app/(main)/quan-tri/csvc/danh-muc/hinh-thuc-su-dung/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyHinhthucsudung(dataImport, access_token ?? '');
