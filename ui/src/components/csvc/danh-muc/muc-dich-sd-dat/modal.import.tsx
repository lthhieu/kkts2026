...
import { handleCreateManyMucdichsudungdat } from '@/app/(main)/quan-tri/csvc/danh-muc/muc-dich-sd-dat/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyMucdichsudungdat(dataImport, access_token ?? '');
