...
import { handleCreateManyXaphuong } from '@/app/(main)/quan-tri/csvc/danh-muc/xa-phuong/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyXaphuong(dataImport, access_token ?? '');
