...
import { handleCreateManyPhanloai } from '@/app/(main)/quan-tri/csvc/danh-muc/phan-loai/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyPhanloai(dataImport, access_token ?? '');
