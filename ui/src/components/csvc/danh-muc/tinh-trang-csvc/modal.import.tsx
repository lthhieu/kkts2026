...
import { handleCreateManyTinhtrangcsvc } from '@/app/(main)/quan-tri/csvc/danh-muc/tinh-trang-csvc/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyTinhtrangcsvc(dataImport, access_token ?? '');
