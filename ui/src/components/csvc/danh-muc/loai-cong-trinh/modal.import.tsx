...
import { handleCreateManyLoaicongtrinhcsvc } from '@/app/(main)/quan-tri/csvc/danh-muc/loai-cong-trinh/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyLoaicongtrinhcsvc(dataImport, access_token ?? '');
