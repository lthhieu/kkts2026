            ...
            <Modal title="Import dữ liệu" open={isModalImportOpen} onOk={handleOk} okText="Import"
                ...
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        Chỉ hỗ trợ file excel và csv <a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-danhmuc.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <Table<{ name: string }>
