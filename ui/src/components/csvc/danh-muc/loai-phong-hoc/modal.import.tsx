...
import { handleCreateManyLoaiphonghoc } from '@/app/(main)/quan-tri/csvc/danh-muc/loai-phong-hoc/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyLoaiphonghoc(dataImport, access_token ?? '');
