...
import { handleCreateManyTinhtrangsudung } from '@/app/(main)/quan-tri/csvc/danh-muc/tinh-trang-su-dung/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyTinhtrangsudung(dataImport, access_token ?? '');
