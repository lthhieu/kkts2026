...
import { handleCreateManyLoaidean } from '@/app/(main)/quan-tri/csvc/danh-muc/loai-de-an/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyLoaidean(dataImport, access_token ?? '');
