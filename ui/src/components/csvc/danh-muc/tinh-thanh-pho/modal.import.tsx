...
import { handleCreateManyTinhthanhpho } from '@/app/(main)/quan-tri/csvc/danh-muc/tinh-thanh-pho/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyTinhthanhpho(dataImport, access_token ?? '');
