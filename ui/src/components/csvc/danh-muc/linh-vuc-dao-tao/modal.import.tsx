...
import { handleCreateManyLinhvucdaotao } from '@/app/(main)/quan-tri/csvc/danh-muc/linh-vuc-dao-tao/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyLinhvucdaotao(dataImport, access_token ?? '');
