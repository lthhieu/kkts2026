...
import { handleCreateManyLuachon } from '@/app/(main)/quan-tri/csvc/danh-muc/lua-chon/actions';
...
const ModalImport = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyLuachon(dataImport, access_token ?? '');
