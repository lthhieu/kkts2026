...
import { handleCreateManyXth } from '@/app/(main)/quan-tri/csvc/xth/actions';
...
const ModalImportXth = (props: IProps) => {
                ...
                try {
                    ...
                    worksheet.eachRow((row, rowNumber) => {
                        ...
                        jsonData.push({
                            ...
                            phuc_vu_nganh: getVal(2) ? String(getVal(2)) : null,
                            muc_do_dap_ung_nhu_cau_nckh: getVal(3) ? String(getVal(3)) : '',
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyXth(dataImport, access_token ?? '');
            if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title="Import dữ liệu xưởng thực hành"
            ...
            >
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        ...
                        &nbsp;<a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-xth.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <div>
                    <Table<any>
                        ...
                        columns={[
                            { dataIndex: 'ma_ct_csvc', title: 'Mã cơ sở vật chất' },
