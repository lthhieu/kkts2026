    ...
    return (
        <div>
            <Descriptions
                column={{ xs: 1, sm: 3 }}
            >
                <Descriptions.Item span={'filled'} label="Mã tòa nhà">{data.ma_toanha ?? '—'}</Descriptions.Item>
                <Descriptions.Item span={'filled'} label="Tên tòa nhà">{data.ten_toanha ?? '—'}</Descriptions.Item>
