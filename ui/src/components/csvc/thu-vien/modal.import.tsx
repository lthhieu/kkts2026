                ...
                try {
                    ...
                    worksheet.eachRow((row, rowNumber) => {
                        ...
                        jsonData.push({
                            ...
                            soluong_dau_sach: Number(getVal(15)) || 0,
                            soluong_dau_tap_chi: Number(getVal(16)) || 0,
                            soluong_dau_sach_dien_tu: Number(getVal(17)) || 0,
                            soluong_dau_tap_chi_dien_tu: Number(getVal(18)) || 0,
                            so_dau_sach_dien_tu_co_truy_cap_truc_tuyen: Number(getVal(19)) || 0,
                            so_dau_sach_co_ban_in: Number(getVal(20)) || 0,
                            so_dau_sach_in_co_the_muon_truc_tiep: Number(getVal(21)) || 0,
                            tinhtrangcsvc: getVal(22) ? String(getVal(22)) : null,
                            htsh: getVal(23) ? String(getVal(23)) : null,
                            tinh_trang_sd: getVal(24) ? String(getVal(24)) : null,
                            ngay_chuyen_tt: getVal(25) ? String(getVal(25)) : null,
