...
import { handleCreateManyPhongchucnang } from '@/app/(main)/quan-tri/csvc/phong-chucnang/actions';
...
const ModalImportPhongchucnang = (props: IProps) => {
                ...
                try {
                    ...
                    worksheet.eachRow((row, rowNumber) => {
                        ...
                        const obj = {
                            ...
                            type: getVal(3) ? String(getVal(3)) : '',
                            dtxd: Number(getVal(4)) || 0,
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyPhongchucnang(dataImport, access_token ?? '');
            if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title="Import dữ liệu phòng - chức năng"
            ...
            >
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        Chỉ hỗ trợ file excel và csv <a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-phongchucnang.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <div>
                    <Table<any>
                        ...
                        columns={[
                            ...
                            { dataIndex: 'type', title: 'Loại phòng' },
                            { dataIndex: 'dtxd', title: 'Diện tích xây dựng (m²)' },
...
export default ModalImportPhongchucnang;
