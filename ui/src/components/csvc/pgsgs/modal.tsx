'use client'
import { handleCreateOrUpdatePgsgs } from '@/app/(main)/quan-tri/csvc/pgs-gs/actions';
...
const PgsgsModal = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        const response = await handleCreateOrUpdatePgsgs(payload, access_token ?? '', status, dataUpdate);
        if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title={status === 'CREATE' ? 'Thêm phòng phó giáo sư - giáo sư' : 'Cập nhật phòng phó giáo sư - giáo sư'}
