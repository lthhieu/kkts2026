'use client'
import { handleCreateOrUpdateNhaxuong } from '@/app/(main)/quan-tri/csvc/nha-xuong/actions';
...
const NhaxuongModal = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        const response = await handleCreateOrUpdateNhaxuong(payload, access_token ?? '', status, dataUpdate);
        if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title={status === 'CREATE' ? 'Thêm nhà xưởng' : 'Cập nhật nhà xưởng'}
