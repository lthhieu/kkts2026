...
import { handleCreateManyNhaxuong } from '@/app/(main)/quan-tri/csvc/nha-xuong/actions';
...
const ModalImportNhaxuong = (props: IProps) => {
    ...
    const handleOk = () => {
        ...
        setTimeout(async () => {
            const response = await handleCreateManyNhaxuong(dataImport, access_token ?? '');
            if (response.data) {
    ...
    return (
        <Context.Provider value={contextValue}>
            ...
            <Modal
                title="Import dữ liệu nhà xưởng"
            ...
            >
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        Chỉ hỗ trợ file excel và csv <a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-nhaxuong.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <div>
                    <Table<any>
...
export default ModalImportNhaxuong;
