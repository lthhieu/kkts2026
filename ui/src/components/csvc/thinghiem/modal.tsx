'use client'
import { handleCreateOrUpdateThinghiem } from '@/app/(main)/quan-tri/csvc/thi-nghiem/actions';
...
const ThinghiemModal = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        const response = await handleCreateOrUpdateThinghiem(payload, access_token ?? '', status, dataUpdate);
        if (response.data) {
