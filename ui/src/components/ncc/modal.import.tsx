...
import { handleCreateMany } from '@/app/(main)/quan-tri/ncc/actions';
            ...
            >
                <Dragger {...uploadProps}>
                    ...
                    <p className="ant-upload-hint">
                        Chỉ hỗ trợ file excel và csv <a onClick={(e) => e.stopPropagation()} href={`${process.env.NEXT_PUBLIC_FRONTEND_URI}sample/sample-ncc.xlsx`} download>Tải file mẫu</a>
                    </p>
                </Dragger>
                <div>
                    <Table<IUpload>
                        ...
                        columns={[
                            { dataIndex: 'name', title: 'Tên nhà cung cấp' }
                        ]} />
                </div>
            </Modal>
        </Context.Provider>
