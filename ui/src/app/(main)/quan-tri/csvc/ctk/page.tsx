...
type Params = Promise<{ current: string; pageSize: string; ma_ct?: string; ten_ct?: string; loaicongtrinhcsvc?: string; mucdichsudungcsvc?: string }>
...
const CtkPage = async ({ searchParams }: { searchParams: Params }) => {
    ...
    const { pageSize = 20, current = 1, ma_ct, ten_ct, loaicongtrinhcsvc, mucdichsudungcsvc } = await searchParams
